...
import { showArticles } from "../reducers/hiddenArticles";
...
function Header() {
  ...
  const handleRegister = () => {
    fetch("https://morningnews-backend-seven-cyan.vercel.app/users/signup", {
      method: "POST",
  ...
  const handleConnection = () => {
    fetch("https://morningnews-backend-seven-cyan.vercel.app/users/signin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  return (
    <header className={styles.header}>
      <div className={styles.logoContainer}>
        ...
        {userSection}
        <FontAwesomeIcon
          onClick={() => dispatch(showArticles())} // utiliser dispatch pour accéder au reducer pas besoin de props, juste on vide le tableau
          icon={faEye}
